...
const Hero = () => {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      gsap.fromTo([titlePart1Ref.current, titlePart2Ref.current, subtitleRef.current, btnRef.current],
        { y: 30, opacity: 0 },
    ...
    <section ref={heroRef} className="relative min-h-[90dvh] w-full flex items-center justify-center pt-20 px-8 bg-hero-waves">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-center text-center gap-6">
        ...
        <Link 
          ref={btnRef}
          to="/app" 
          className="opacity-0 mt-8 btn-gradient px-8 py-4 rounded-2xl text-lg font-medium transition-transform hover:scale-[1.02] shadow-xl shadow-accent/20 flex items-center gap-2"
        >
          Ouvrir le Lexique
        </Link>
      </div>
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-4xl mx-auto">
          <div className="bg-primary rounded-3xl p-10 flex flex-col shadow-xl">
            ...
            <Link to="/app" className="w-full text-center bg-surface text-white py-3 rounded-xl text-sm font-medium hover:bg-white/5 transition-colors border border-white/5">Commencer</Link>
          </div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link to="/app" className="text-sm text-white/50 hover:text-white transition-colors">Lexique</Link>
